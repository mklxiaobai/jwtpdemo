...
import com.mkl.hengyimes.common.utils.JSONUtil;
import com.mkl.hengyimes.common.utils.ReflectUtil;
...
public class AuthoritiesController extends BaseController {
    ...
    public PageResult<Map<String, Object>> list(Integer roleId, String keyword) {
        ...
        List<Authorities> authorities = authoritiesService.list(new QueryWrapper<Authorities>().orderBy(true, true,"sort"));
        // 筛选结果
